...
/**
 *          *** for this lab...do not change this file - 
 *          *** make all changes in UndirectedNonWeightedExampleSlide19House
 *          ***
 * Date Modified:   11/26/2012 - removed package, clone, depth/bredth search
 *                  11/13/2016 - NetBeanafied
 *                  4/12/2017 - Comments added
 * @author Michael Main (Trimmed by Stephen Brower)
 */
public class Graph {
    ...
    /**
     * addEdge method receives 2 locations. The second location is added as a
     * neighbor to the first Location passed.
     *
    ...
    /**
     * isEdge method receives 2 Locations. the second Location is checked to see
     * if it is a neighbor of the first Location
     *
     * @param source Location to check for a neighbor
     * @param target other Location that is being checked to see if it is a
     * neighbor
     * @return boolean that indicates if the second Location is a neighbor of
     * the first Location
     */
    ...
    /**
     * the neighbors method builds an array of Location which are the neighbors
    ...
    /**
     * removeEdge method receives 2 locations. The second location is removed as
     * a neighbor to the first Location passed.
     *

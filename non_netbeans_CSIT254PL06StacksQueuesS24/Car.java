 ...
 *
 * Programmed by Stephen Brower Date Modified 2/10/2014 - added comments in
 * JavaDoc format
 */
...
public class Car implements Comparable<Car> {
    ...
    /**
     * The compareTo method compares this Car to another Object . if this car is
     * before other car, return a value < 0.
     * if this car is after other car, return a value > 0. if this car is equal
     * to other car, return 0.
     *
     * @param The object to test for equality.
    ...
    /**
     * The toString method returns a Car object's yearModel, make, speed as a
     * String.
     *

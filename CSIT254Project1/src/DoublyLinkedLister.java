 ...
 */
public class DoublyLinkedLister<E> {

    private DoublyLinkedNode<E> cursor;

    /**
     * Constructor establishes cursor as the beginning of the linked list
     *
     * @param head points to a linked list of Node<E>
     */
    public DoublyLinkedLister(DoublyLinkedNode<E> head) {
